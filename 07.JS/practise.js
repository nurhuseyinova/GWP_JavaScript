...
// console.log(countries_data.sort((a,b)=>a.area-b.area).slice(0,10));
// console.log(countries_data.sort((a,b)=>a.population-b.population).slice(0,10));
// console.log(countries_data.filter((el)=>el.languages=="English"));
...
// console.log(countries_data.map((el)=>`${el.region}:  ${el.capital}`));
